            ...
            <div className='md:w-2/3'>
                <div className='border p-2 mb-6'>
                    ...
                    onClick={() => setBillingToggle(!billingToggle)}>
                        <h3 className='text-lg fontsemibold mb-2'>Payment Details</h3>
                ...
                <div className='border p-2 mb-6'>
                    ...
                    onClick={() => setShippingToggle(!shippingToggle)}>
                        <h3 className='text-lg fontsemibold mb-2'>Shipping Details</h3>
                ...
                <div className='border p-2 mb-6'>
                    ...
                    onClick={() => setPaymentToggle(!paymentToggle)}>
                        <h3 className='text-lg fontsemibold mb-2'>Payment Method</h3>
